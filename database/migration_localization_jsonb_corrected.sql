-- Migration CORRIGÉE pour localisation avec JSONB
-- Version finale sans erreurs de syntaxe PostgreSQL
...
-- Supprimer les arrays vides (en utilisant une sous-requête pour éviter l'erreur)
DELETE FROM fc_questions 
  ...
  LOOP
    ...
    IF first_key IS NOT NULL THEN
      ...
      IF jsonb_typeof(first_value) = 'array' THEN
        -- Vérifier que l'array n'est pas vide en utilisant une sous-requête
...
-- ============================================
-- ÉTAPE 9 : NETTOYER LES DONNÉES INVALIDES (AVANT CONTRAINTES)
-- ============================================
...
-- Vérifier qu'il ne reste que des questions valides
DO $$
DECLARE
  total_count INTEGER;
  valid_count INTEGER;
BEGIN
  ...
  IF total_count != valid_count THEN
    RAISE WARNING 'ATTENTION: Il reste % questions invalides sur % total. Les contraintes vont échouer.', (total_count - valid_count), total_count;
  ELSE
    RAISE NOTICE 'Toutes les questions sont valides. On peut ajouter les contraintes.';
  END IF;
END $$;

-- ============================================
-- ÉTAPE 10 : CRÉER DES FONCTIONS POUR LES CONTRAINTES
-- ============================================
...
-- ============================================
-- ÉTAPE 11 : AJOUTER LES CONTRAINTES
-- ============================================
...
-- ============================================
-- ÉTAPE 11 : CRÉER LES FONCTIONS HELPER
-- ============================================
